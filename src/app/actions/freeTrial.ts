...
const FreeTrialSchema = z.object({
  ...
  pinCode: z.string().regex(/^\d{6}$/, { message: 'Please enter a valid 6-digit pin code.' }).optional(),
  address: z.string().min(6, { message: 'Please enter a valid pin code or location.' }),
